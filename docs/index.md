...
## 実験時限
木曜の3限〜4限です。3限の最初に、その週の実験内容を説明しますので、遅刻しないように注意してください。

## 実験場所
演習室6で実施します。個人のPCを使用します。念の為、充電器も持参してください。
...
### Week 0：事前準備
事前にアカウントの作成やPCの用意を行ってもらいます。特にPCのOSを確認してください。<span style="color: #CC0066;">WindowsのHomeエディションを使っている人には、Educationエディションへのアップグレードをオススメします。</span>
