...
## 実験時限
木曜の3限〜4限です。3限の最初に、その週の実験内容を説明しますので、遅刻しないように注意してください。よろしくお願いします。
...
### Week 0：事前準備
個人でアカウントの作成やPCの用意を行います。特にPCのOSを確認してください。<span style="color: #CC0066;">WindowsのHomeエディションを使っている人には、Educationエディションへのアップグレードをオススメします。</span>

- [事前準備](https://stl-apu.github.io/laboratory_experiments/preparetion)

### Week 1（更新中）
個人でROSの仕組みを学びます。<span style="color: #CC0066;">インストールコマンドはPCの電力を大量に消費しますので、PCの充電器を持参することをオススメします。</span>
